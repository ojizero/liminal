...
#
#     PHX_SERVER=true bin/liminal start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :liminal, LiminalWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/liminal/liminal.db
      """
  ...
  upload_dir =
    System.get_env("UPLOAD_DIR") ||
      Path.join(Application.app_dir(:liminal, "priv/static"), "uploads/images")

  config :liminal, :upload_dir, upload_dir
  config :liminal, :upload_static_from, Path.dirname(upload_dir)
