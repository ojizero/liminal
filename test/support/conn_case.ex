defmodule LiminalWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LiminalWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import LiminalWeb.ConnCase
    end
  end

  setup tags do
    Liminal.DataCase.setup_sandbox(tags)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Liminal.Accounts.generate_user_session_token(user)
